...
//Distintas formas de concatenar, concat es un metodo solo para los strings, o lo puedo forzar
...
let nombre = "Fernanda";
let saludin = `Hola ${nombre}, que gusto verte!`; // buena practica al concatenar texto entre comillas y comillas simples 
